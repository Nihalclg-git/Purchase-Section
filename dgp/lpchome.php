  ...
  <div class="container-fluid vh-100">
    <div class="row vh-100">
      <div class="col-md-2 col-height left-col">
		...
		<div class="sidebar">
  <ul>
    <li><a href="home.php"><i class="fas fa-shopping-cart"></i>  Request a Purchase</a>
	<ul>
	<li><a href="home.php">Direct Purchase</a></li>
	<li><a href="lpchome.php">Local Purchase Committee</a></li>
	<li><a href="sthome.php">Purchase by Single origin</a></li>
	<li><a href="gthome.php">Global Tender</a></li>
	</ul>
	</li>
    <li><a href="#"><i class="fas fa-check-square"></i>  Purchase Status</a></li>
	...
	<li><a href="login.php"><i class="fas fa-sign-out-alt"></i> Logout</a></li>
      ...
      <div class="col-md-10 col-height right-col">
		...
		<header>
  <div class="user-info">
    <span><b>Welcome, Dr.<?php echo $_SESSION['username']; ?></b>
	<i class="fa fa-user-circle" aria-hidden="true"></i>
		...
		<div class="bottom">
		<h4><center>Local Purchase Committee Request</center></h4>
...
<div class="modal fade" id="addItemModal" tabindex="-1" role="dialog" aria-labelledby="addItemModalLabel" aria-hidden="true">
  ...
  descCell.innerHTML = itemDesc;
  qtyCell.innerHTML = itemQty;
  rateCell.innerHTML = "&#8377;" + itemRate;
...
$indenter_name = mysqli_real_escape_string($conn, $_SESSION['username']);
$department = mysqli_real_escape_string($conn, $_POST['department']);
$purpose = mysqli_real_escape_string($conn, $_POST['purpose']);
$comments = mysqli_real_escape_string($conn, $_POST['comments']);
$origin = mysqli_real_escape_string($conn, $_POST['origin']);
$preferred_delivery_date = mysqli_real_escape_string($conn, $_POST['preferred_delivery_date']);
$indent_type = mysqli_real_escape_string($conn, $_POST['indent_type']);
$indent_type = "Purchase by Local Purchase Committee";
$status = NULL;

// Insert data into database
$sql = "INSERT INTO indents (id, indenter_name, department, purpose, comments, origin, preferred_delivery_date, indent_type, status)
VALUES ('$timestamp', '$indenter_name', '$department', '$purpose', '$comments', '$origin', '$preferred_delivery_date', '$indent_type', '$status')";

if (mysqli_query($conn, $sql)) {
  echo "Purchase Request sent successfully";
} else {
